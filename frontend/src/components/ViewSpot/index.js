      ...
      <div className="view-container">
        ...
        <div className="spot__spot-info">
          ...
          <div className="spot-info-right">
            ...
            { userObj && spotObj ? userObj.id === spotObj.ownerId ?
              <button className="btn login-btn reserve-btn" onClick={() => history.push(`/user/spots/${spotObj.id}`)}>
                Update
              </button>
            :
              <button className="btn login-btn reserve-btn">
                <OpenModalButton className="btn" buttonText="Reserve" modalComponent={<ReservationModal spot={spotObj} />} />
              </button>
            :
              <button className="btn login-btn">Log in to Book</button>
            }
          </div>
        </div>
